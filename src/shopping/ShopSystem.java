...
public class ShopSystem extends JPanel {

	private static final long serialVersionUID = 1L;

	private JButton addButton;// 添加
	private JButton delButton;// 删除
	private JButton EmptyButton;// 清空
	private JButton PayButton;// 付款
	private JButton BillButton;// 清单
	private JButton clsButton;// 清屏
	private JButton topScreenButton, bottomScreenButton;// 首位末尾
	private JTextField nameField;
	private JTextField numField;
	private JTextField priceField;
	private JTextArea recordTextArea;// 记录
	private JScrollPane screen;// 记录的屏幕
	private Vector<Goods> data; // 存放商品的数组
	private String s;// 记录里的字符串，用拼接的方式累加
	...
	public ShopSystem() {
		...
		recordTextArea.setLineWrap(true);// 如果内容过长。自动换行
